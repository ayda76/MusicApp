                                                            ...
                                                            <div class="statbox widget box box-shadow">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="table-responsive mb-4 mt-4">
                                                                        <jsp:useBean id="Album" class="com.myapp.struts.Dao.do_Album" scope="request"></jsp:useBean>
                                                                        <form name="Customer" method="get" action="<%=request.getContextPath()%>/Album_Servlet" >
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="hidden" class="form-control mb-4" name ="code" id="code" placeholder="کد" value="${Album.abum_id}">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <label for="profession">نام آلبوم </label>
                                                                                                <input type="text" class="form-control mb-4" name ="c_name" id="c_name" placeholder="نام دسته " value="${Album.albumname}">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                
                                                                                                <input type="hidden" class="form-control mb-4" name ="c_singerid" id="c_singerid" placeholder="کد پدر " value="${Album.singer_id}">
                                                                                            </div>
                                                        ...
                                                        <form name="Customer" method="post" action="<%=request.getContextPath()%>/Users_Servlet" >
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" name ="code" id="code" placeholder="کد" value="${Singer.lname}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="profession">نام دسته </label>
                                                                    <input type="text" class="form-control mb-4" name ="c_name" id="c_name" placeholder="نام دسته " value="${Singer.lname}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="profession">کد پدر</label>
                                                                    <input type="text" class="form-control mb-4" name ="c_parent" id="c_parent" placeholder="کد پدر " value="${Singer.lname}">
                                                                </div>
