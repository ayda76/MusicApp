                                                    ...
                                                    <div class="page-header">
                                                        ...
                                                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                                                            <ol class="breadcrumb">
                                                                ...
                                                                <li class="breadcrumb-item active" aria-current="page"><span>مدیریت آلبم ها </span></li>
                                                            </ol>
                                                        </nav>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">ایجاد آلبوم جدید</h5>

                                                </div>
                                                <form name="Customer" method="post" action="<%=request.getContextPath()%>/Album_Servlet" >
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="profession">نام آلبوم</label>
                                                            <input type="text" class="form-control mb-4" name ="u_name" id="u_name" placeholder="نام آلبوم" >
                                                        </div>
                                                        <div class="form-group">
                                                            
                                                            <input type="hidden" value="0" class="form-control mb-4" name ="u_singerid" id="u_singerid" placeholder="کد خواننده " >
                                                        </div>                                                        
