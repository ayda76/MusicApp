                                                    ...
                                                    <div class="page-header">
                                                        ...
                                                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                                                            <ol class="breadcrumb">
                                                                ...
                                                                <li class="breadcrumb-item active" aria-current="page"><span>مدیریت موزیک ها</span></li>
                                                            </ol>
                                                        </nav>
                                                        ...
                                                        <div id="fuSingleFile" class="col-xl-12  col-md-12">
                                                            <div class="statbox widget box box-shadow">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <a href="insertsong.jsp" class="btn btn-success mb-2 mr-2" >ایجاد موزیک جدید    </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">ایجاد خواننده جدید</h5>

                                                </div>
                                                <form name="Customer" method="post" action="<%=request.getContextPath()%>/Singer_Servlet" >
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="profession">نام </label>
                                                            <input type="text" class="form-control mb-4" name ="s_name" id="s_name" placeholder="نام" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">نام خانوادگی </label>
                                                            <input type="text" class="form-control mb-4" name ="s_family" id="s_family" placeholder="نام خانوادگی " >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">تاریخ تولد</label>
                                                            <input type="text" class="form-control mb-4" name ="s_birthday" id="s_birthday" placeholder="تاریخ تولد" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">کشور محل زندگی</label>
                                                            <input type="text" class="form-control mb-4"  name ="s_cuntry" id="s_cuntry" placeholder="کشور محل زندگی" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">جنسیت</label>
                                                            <input type="text" class="form-control mb-4"  name ="s_sex" id="s_sex" placeholder="جنسیت" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">ایمیل </label>
                                                            <input type="text" class="form-control mb-4"  name ="s_email" id="s_email" placeholder="ایمیل" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="profession">موبایل </label>
                                                            <input type="text" class="form-control mb-4"  name ="s_mobile" id="s_mobile" placeholder="موبایل" >
                                                        </div>
