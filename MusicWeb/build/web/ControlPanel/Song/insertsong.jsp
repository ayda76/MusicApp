...
<%@page import="com.myapp.struts.Controller.co_Album"%>
                                                ...
                                                <div class="container">                   
                                                    <div class="row layout-top-spacing">
                                                        ...
                                                        <div id="fuSingleFile" class="col-lg-12 layout-spacing">
                                                             ...
                                                             <form name="Song" method="post" action="<%=request.getContextPath()%>/Song_Servlet" enctype="multipart/form-data">
                                                            <div class="statbox widget box box-shadow">
                                                                ...
                                                                <div class="widget-header">
                                                                    ...
                                                                    <div class="widget-content widget-content-area">
                                                                        <input name="MusicName" id="MusicName" type="text" class="form-control"/>
                                                                ...
                                                                <div class="widget-header">
                                                                    <script>
                                                                    function myFunctionSinger(values) {
                                                                      document.getElementById("singer").value =values;
                                                                    }
                                                                    </script>
                                                                    <script>
                                                                    function myFunctionAlbum(values) {
                                                                      document.getElementById("Album").value =values;
                                                                    }
                                                                    </script>
                                                                    <script>
                                                                    function myFunctionCategory(values) {
                                                                      document.getElementById("Category").value =values;
                                                                    }
                                                                    </script>
                                                                    <div class="widget-content widget-content-area">
                                                                        
                                                                        <input type="hidden" id ="singer" name="singer"/>
                                                                ...
                                                                <div class="widget-content widget-content-area">
                                                                    ...
                                                                    <input type="file" id="file" name="file" accept=".mp3" class="btn btn-success mb-2 mr-2"><br><br>
                                                                ...
                                                                <div class="widget-content widget-content-area">
                                                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                                                        ...
                                                                        <label class="custom-file-container__custom-file" >
                                                                            <input type="file" name="filePic" id="filePic" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
