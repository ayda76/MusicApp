                                                            ...
                                                            <div class="statbox widget box box-shadow">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="table-responsive mb-4 mt-4">
                                                                        <jsp:useBean id="Category" class="com.myapp.struts.Dao.do_Category" scope="request"></jsp:useBean>
                                                                        <form name="Customer" method="get" action="<%=request.getContextPath()%>/Category_Servlet" >
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="text" class="form-control mb-4" name ="code" id="code" placeholder="کد" value="${Category.category_id}">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <label for="profession">نام دسته </label>
                                                                                                <input type="text" class="form-control mb-4" name ="c_name" id="c_name" placeholder="نام دسته " value="${Category.categoryname}">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                
                                                                                                <input type="hidden" class="form-control mb-4" name ="c_parent" id="c_parent" placeholder="کد پدر " value="${Category.parent}">
                                                                                            </div>
