                                                            ...
                                                            <div class="statbox widget box box-shadow">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="table-responsive mb-4 mt-4">
                                                                        <jsp:useBean id="Users" class="com.myapp.struts.Dao.do_Users" scope="request"></jsp:useBean>
                                                                        <form name="Customer" method="get" action="<%=request.getContextPath()%>/Users_Servlet" >
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <input type="hidden" class="form-control mb-4" name ="action" id="action" placeholder="نام" value="setedit">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control mb-4" name ="u_id" id="u_id" placeholder="نام" value="${Users.user_id}">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="profession">نام </label>
                                                                                        <input type="text" class="form-control mb-4" name ="u_name" id="u_name" placeholder="نام" value="${Users.lname}">
                                                                                    </div>
                                                                                    
                                                                                    <div class="form-group">
                                                                                        <label for="profession">نام خانوادگی </label>
                                                                                        <input type="text" class="form-control mb-4" name ="u_family" id="u_family" placeholder="نام خانوادگی " value="${Users.fname}">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="profession">نام کاربری</label>
                                                                                        <input type="text" class="form-control mb-4" name ="u_username" id="u_username" placeholder="نام کاربری" value="${Users.username}">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="profession">کلمه عبور </label>
                                                                                        <input type="text" class="form-control mb-4"  name ="u_password" id="u_password" placeholder="کلمه عبور" value="${Users.password}">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="profession">ایمیل </label>
                                                                                        <input type="text" class="form-control mb-4"  name ="u_email" id="u_email" placeholder="ایمیل" value="${Users.email}">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="profession">موبایل </label>
                                                                                        <input type="text" class="form-control mb-4"  name ="u_mobile" id="u_mobile" placeholder="موبایل" value="${Users.mobile}">
                                                                                    </div>
